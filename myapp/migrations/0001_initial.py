    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.botuser', to_field='telegram_id', verbose_name='User')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=150, null=True, verbose_name='Product name')),
                ('name_uz', models.CharField(blank=True, max_length=150, null=True, verbose_name='Product name')),
                ('name_ru', models.CharField(blank=True, max_length=150, null=True, verbose_name='Product name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longitude', models.CharField(blank=True, max_length=50, null=True, verbose_name='logitude')),
